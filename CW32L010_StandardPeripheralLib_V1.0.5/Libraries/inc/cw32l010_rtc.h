...
#ifndef __CW32L010_RTC_H
#define __CW32L010_RTC_H
...
#define RTC_IT_ALL                              (RTC_IT_ALARMA|RTC_IT_ALARMB|RTC_IT_AWTIMER|RTC_IT_TAMP|RTC_IT_TAMPOV|RTC_IT_INTERVAL) 
...
//============================================================
//  cw32l010 RTC HAL API Function（Total： 14），及所有位域的宏命令
//============================================================
...
void RTC_AWT_PSC_set(uint8_t PSC1A,uint32_t PSC2A);//RTC的自动唤醒定时器PSC1 PSC2设置
