#line 1 "..\\..\\..\\..\\Libraries\\src\\cw32l010_gpio.c"
...
#line 30 "..\\..\\..\\..\\Libraries\\src\\cw32l010_gpio.c"
...
#line 31 "..\\..\\..\\..\\Libraries\\src\\cw32l010_gpio.c"
...
void GPIO_Init(GPIO_TypeDef  *GPIOx, GPIO_InitTypeDef *GPIO_Init)
{
    ...
    {
        case (uint32_t)((GPIO_TypeDef*) 0x48000000UL):
            ((SYSCTRL_TypeDef*) 0x40004000UL)->AHBEN |= (0x5A5A0000U) | (0x10UL);
            break;

        case (uint32_t)((GPIO_TypeDef*) 0x48000100UL):
            ((SYSCTRL_TypeDef*) 0x40004000UL)->AHBEN |= (0x5A5A0000U) | (0x20UL);
            break;
        default:
            break;
    }

    if (GPIO_Init->Mode == (0X00))      
    {
        ( (GPIOx->ANALOG) |= (GPIO_Init->Pins) );
    }
    else
    {
        ( (GPIOx->ANALOG) &= (~((uint32_t)(GPIO_Init->Pins))) );                  

        if ((GPIO_Init->Mode & (0x10)) == (0x10))  
        {
            ( (GPIOx->DIR) |= (GPIO_Init->Pins) );
            
            ( (GPIOx->PUR) &= (~((uint32_t)(GPIO_Init->Pins))) );

            if (GPIO_Init->Mode == (0x11))
            {
                ( (GPIOx->PUR) |= (GPIO_Init->Pins) );               
            }           

            ( (GPIOx->RISEIE) &= (~((uint32_t)(GPIO_Init->Pins))) );
            ( (GPIOx->FALLIE) &= (~((uint32_t)(GPIO_Init->Pins))) );

            if ((GPIO_Init->IT & (0x81)) == (0x81))
            {
                ( (GPIOx->RISEIE) |= (GPIO_Init->Pins) );
            }

            if ((GPIO_Init->IT & (0x82)) == (0x82))
            {
                ( (GPIOx->FALLIE) |= (GPIO_Init->Pins) );
            }
        }
        else                                                           
        {
            ( (GPIOx->DIR) &= (~((uint32_t)(GPIO_Init->Pins))) );

            if (GPIO_Init->Mode == (0x20))
            {
                ( (GPIOx->OPENDRAIN) &= (~((uint32_t)(GPIO_Init->Pins))) );
            }
            else
            {
                ( (GPIOx->OPENDRAIN) |= (GPIO_Init->Pins) );
            }
        }        
    }
}
...
void GPIO_DeInit(GPIO_TypeDef  *GPIOx, uint32_t GPIO_Pins)
{
    ( (GPIOx->ANALOG) |= (GPIO_Pins) );
    ( (GPIOx->DIR) |= (GPIO_Pins) );
    ( (GPIOx->PUR) &= (~((uint32_t)(GPIO_Pins))) );

    ( (GPIOx->RISEIE) &= (~((uint32_t)(GPIO_Pins))) );
    ( (GPIOx->FALLIE) &= (~((uint32_t)(GPIO_Pins))) );
    ( (GPIOx->OPENDRAIN) &= (~((uint32_t)(GPIO_Pins))) );
}
...
void GPIO_SWD2GPIO(void)
{
    ((SYSCTRL_TypeDef*) 0x40004000UL)->CR2 =  ((SYSCTRL_TypeDef*) 0x40004000UL)->CR2 | (0x5A5A0000 | (((uint32_t)1u) << 1));
}
...
void GPIO_GPIO2SWD(void)
{
    ((SYSCTRL_TypeDef*) 0x40004000UL)->CR2 =  0x5A5A0000 | (((SYSCTRL_TypeDef*) 0x40004000UL)->CR2 & (~((((uint32_t)1u) << 1))));
}
...
void GPIO_RST2GPIO(void)
{
    ((SYSCTRL_TypeDef*) 0x40004000UL)->CR2 =  ((SYSCTRL_TypeDef*) 0x40004000UL)->CR2 | (0x5A5A0000 | (((uint32_t)1u) << 0));
}
...
void GPIO_GPIO2RST(void)
{
    ((SYSCTRL_TypeDef*) 0x40004000UL)->CR2 =  0x5A5A0000 | (((SYSCTRL_TypeDef*) 0x40004000UL)->CR2 & (~((((uint32_t)1u) << 0))));
}
