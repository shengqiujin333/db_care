#line 1 "..\\..\\..\\..\\Libraries\\src\\cw32l010_adc.c"
...
#line 36 "..\\..\\..\\..\\Libraries\\src\\cw32l010_adc.c"
...
#line 37 "..\\..\\..\\..\\Libraries\\src\\cw32l010_adc.c"
...
#line 38 "..\\..\\..\\..\\Libraries\\src\\cw32l010_adc.c"
...
#line 39 "..\\..\\..\\..\\Libraries\\src\\cw32l010_adc.c"
...
void ADC_DeInit(void)
{
    ...
    ( (((SYSCTRL_TypeDef*) 0x40004000UL)->APBRST1) &= (~((uint32_t)((0x1UL)))) );
    
    ( (((SYSCTRL_TypeDef*) 0x40004000UL)->APBRST1) |= ((0x1UL)) );
}
...
void ADC_Init(ADC_InitTypeDef *ADC_InitStruct)
{
    ...
    (((((ADC_InitStruct->ADC_ClkDiv) == ((uint32_t)0)) || ((ADC_InitStruct->ADC_ClkDiv) == ((uint32_t)(1U<<4))) || ((ADC_InitStruct->ADC_ClkDiv) == ((uint32_t)(2U<<4))) || ((ADC_InitStruct->ADC_ClkDiv) == ((uint32_t)(3U<<4))))) ? (void)0U : assert_failed((uint8_t *)"..\\..\\..\\..\\Libraries\\src\\cw32l010_adc.c", 93));    
      
    ( (((SYSCTRL_TypeDef*) 0x40004000UL)->APBEN1) |= (((0x5A5A0000U) | (((uint32_t)1u) << 0))) );    

    ( (((ADC_TypeDef*) 0x40000000UL)->CR) = ((((ADC_TypeDef*) 0x40000000UL)->CR) & (~(uint32_t)((0x1c0UL) | (0x30UL) | (0x8UL)))) | (ADC_InitStruct->ADC_SQREns | ADC_InitStruct->ADC_ClkDiv | ADC_InitStruct->ADC_ConvertMode) );
    ...
    ((ADC_TypeDef*) 0x40000000UL)->SQRCFR_f.SQRCH0 = ADC_InitStruct->ADC_IN0.ADC_InputChannel;
    ((ADC_TypeDef*) 0x40000000UL)->SQRCFR_f.SQRCH1 = ADC_InitStruct->ADC_IN1.ADC_InputChannel;
    ((ADC_TypeDef*) 0x40000000UL)->SQRCFR_f.SQRCH2 = ADC_InitStruct->ADC_IN2.ADC_InputChannel;
    ((ADC_TypeDef*) 0x40000000UL)->SQRCFR_f.SQRCH3 = ADC_InitStruct->ADC_IN3.ADC_InputChannel;
    ((ADC_TypeDef*) 0x40000000UL)->SQRCFR_f.SQRCH4 = ADC_InitStruct->ADC_IN4.ADC_InputChannel;
    ((ADC_TypeDef*) 0x40000000UL)->SQRCFR_f.SQRCH5 = ADC_InitStruct->ADC_IN5.ADC_InputChannel;
    ((ADC_TypeDef*) 0x40000000UL)->SQRCFR_f.SQRCH6 = ADC_InitStruct->ADC_IN6.ADC_InputChannel;
    ((ADC_TypeDef*) 0x40000000UL)->SQRCFR_f.SQRCH7 = ADC_InitStruct->ADC_IN7.ADC_InputChannel;
    
    ((ADC_TypeDef*) 0x40000000UL)->SAMPLE_f.SQRCH0 = ADC_InitStruct->ADC_IN0.ADC_SampTime;
    ((ADC_TypeDef*) 0x40000000UL)->SAMPLE_f.SQRCH1 = ADC_InitStruct->ADC_IN1.ADC_SampTime;
    ((ADC_TypeDef*) 0x40000000UL)->SAMPLE_f.SQRCH2 = ADC_InitStruct->ADC_IN2.ADC_SampTime;
    ((ADC_TypeDef*) 0x40000000UL)->SAMPLE_f.SQRCH3 = ADC_InitStruct->ADC_IN3.ADC_SampTime;
    ((ADC_TypeDef*) 0x40000000UL)->SAMPLE_f.SQRCH4 = ADC_InitStruct->ADC_IN4.ADC_SampTime;
    ((ADC_TypeDef*) 0x40000000UL)->SAMPLE_f.SQRCH5 = ADC_InitStruct->ADC_IN5.ADC_SampTime;
    ((ADC_TypeDef*) 0x40000000UL)->SAMPLE_f.SQRCH6 = ADC_InitStruct->ADC_IN6.ADC_SampTime;
    ((ADC_TypeDef*) 0x40000000UL)->SAMPLE_f.SQRCH7 = ADC_InitStruct->ADC_IN7.ADC_SampTime;   
}
...
ErrorStatus ADC_Enable(void)
{
    ( (((ADC_TypeDef*) 0x40000000UL)->CR) |= ((0x1UL)) );   
...
void ADC_Disable(void)
{
    ( (((ADC_TypeDef*) 0x40000000UL)->CR) &= (~((uint32_t)((0x1UL)))) );
}
...
void ADC_WatchdogInit(ADC_WatchdogTypeDef* ADC_WatchdogStruct)
{
    ((((ADC_WatchdogStruct->ADC_WatchdogVth) < 0x1000)) ? (void)0U : assert_failed((uint8_t *)"..\\..\\..\\..\\Libraries\\src\\cw32l010_adc.c", 150));
    ((((ADC_WatchdogStruct->ADC_WatchdogVtl) < 0x1000)) ? (void)0U : assert_failed((uint8_t *)"..\\..\\..\\..\\Libraries\\src\\cw32l010_adc.c", 151));
    (((((ADC_WatchdogStruct->ADC_WatchdogOverHighIrq) == DISABLE) || ((ADC_WatchdogStruct->ADC_WatchdogOverHighIrq) == ENABLE))) ? (void)0U : assert_failed((uint8_t *)"..\\..\\..\\..\\Libraries\\src\\cw32l010_adc.c", 152));
    (((((ADC_WatchdogStruct->ADC_WatchdogUnderLowIrq) == DISABLE) || ((ADC_WatchdogStruct->ADC_WatchdogUnderLowIrq) == ENABLE))) ? (void)0U : assert_failed((uint8_t *)"..\\..\\..\\..\\Libraries\\src\\cw32l010_adc.c", 153));
    
    ADC_Init(&ADC_WatchdogStruct->ADC_InitStruct);
    
    ( (((ADC_TypeDef*) 0x40000000UL)->AWDTR) = ((((ADC_TypeDef*) 0x40000000UL)->AWDTR) & (~(uint32_t)((0xfff0000UL) | (0xfffUL)))) | ((ADC_WatchdogStruct->ADC_WatchdogVth << 16) | ADC_WatchdogStruct->ADC_WatchdogVtl) );

    ((ADC_TypeDef*) 0x40000000UL)->AWDCR = ADC_WatchdogStruct->ADC_WatchdogCHx;
    
    (ADC_WatchdogStruct->ADC_WatchdogOverHighIrq == ENABLE) ? (((ADC_TypeDef*) 0x40000000UL)->IER_f.AWDH = 1) : (((ADC_TypeDef*) 0x40000000UL)->IER_f.AWDH = 0);
    (ADC_WatchdogStruct->ADC_WatchdogUnderLowIrq == ENABLE) ? (((ADC_TypeDef*) 0x40000000UL)->IER_f.AWDL = 1) : (((ADC_TypeDef*) 0x40000000UL)->IER_f.AWDL = 0);    
}
...
void ADC_GetITStatusAll(volatile uint8_t* pFlagAdcIrq)
{
    *pFlagAdcIrq = (uint8_t) (((ADC_TypeDef*) 0x40000000UL)->ISR);
}
...
ITStatus ADC_GetITStatus(uint16_t ADC_IT)
{
    (((((ADC_IT) == ((uint16_t)0x0008)) || ((ADC_IT) == ((uint16_t)0x0004)) || ((ADC_IT) == ((uint16_t)0x0002)) || ((ADC_IT) == ((uint16_t)0x0001)))) ? (void)0U : assert_failed((uint8_t *)"..\\..\\..\\..\\Libraries\\src\\cw32l010_adc.c", 193));
    return (( (((ADC_TypeDef*) 0x40000000UL)->ISR) & (ADC_IT) ) ? SET : RESET);
}
...
void ADC_ClearITPendingAll(void)
{
   ((ADC_TypeDef*) 0x40000000UL)->ICR = 0x0000;
}
...
void ADC_ClearITPendingBit(uint16_t ADC_IT)
{
    (((((ADC_IT) == ((uint16_t)0x0008)) || ((ADC_IT) == ((uint16_t)0x0004)) || ((ADC_IT) == ((uint16_t)0x0002)) || ((ADC_IT) == ((uint16_t)0x0001)))) ? (void)0U : assert_failed((uint8_t *)"..\\..\\..\\..\\Libraries\\src\\cw32l010_adc.c", 218));
    ( (((ADC_TypeDef*) 0x40000000UL)->ICR) &= (~((uint32_t)(ADC_IT))) );
}
...
void ADC_ITConfig(uint16_t ADC_IT, FunctionalState NewState)
{
    ...
    (((((NewState) == DISABLE) || ((NewState) == ENABLE))) ? (void)0U : assert_failed((uint8_t *)"..\\..\\..\\..\\Libraries\\src\\cw32l010_adc.c", 238));
    ((((((ADC_IT) & (uint16_t)0xFFF0) == 0x00) && ((ADC_IT) != 0x00))) ? (void)0U : assert_failed((uint8_t *)"..\\..\\..\\..\\Libraries\\src\\cw32l010_adc.c", 239));
     
    
    if (NewState != DISABLE)
    {
         
        ((ADC_TypeDef*) 0x40000000UL)->IER |= ADC_IT;
    }
    else
    {
         
        ((ADC_TypeDef*) 0x40000000UL)->IER &= (~(uint32_t) ADC_IT);
    }
}
...
void ADC_SoftwareStartConvCmd(FunctionalState NewState)
{
    ...
    (((((NewState) == DISABLE) || ((NewState) == ENABLE))) ? (void)0U : assert_failed((uint8_t *)"..\\..\\..\\..\\Libraries\\src\\cw32l010_adc.c", 266));
    if (NewState != DISABLE)
    {
        ( (((ADC_TypeDef*) 0x40000000UL)->START) |= ((0x1UL)) );
    }
    else
    {
        ( (((ADC_TypeDef*) 0x40000000UL)->START) &= (~((uint32_t)((0x1UL)))) );
    }
}
...
void ADC_ExtTrigCfg(uint16_t ADC_TRIG, FunctionalState NewState)
{
    ...
    (((((NewState) == DISABLE) || ((NewState) == ENABLE))) ? (void)0U : assert_failed((uint8_t *)"..\\..\\..\\..\\Libraries\\src\\cw32l010_adc.c", 311));
    ((((((ADC_TRIG) & (uint32_t)0x00000000) == 0x00) && ((ADC_TRIG) != 0x00))) ? (void)0U : assert_failed((uint8_t *)"..\\..\\..\\..\\Libraries\\src\\cw32l010_adc.c", 312));
     
    trigMask = ADC_TRIG;
    if (NewState != DISABLE)
    {
         
        ((ADC_TypeDef*) 0x40000000UL)->TRIGGER |= trigMask;
    }
    else
    {
         
        ((ADC_TypeDef*) 0x40000000UL)->TRIGGER &= (~(uint32_t) trigMask);
    }
}
...
{
    ((((ResultX) < 0x08)) ? (void)0U : assert_failed((uint8_t *)"..\\..\\..\\..\\Libraries\\src\\cw32l010_adc.c", 336));
    
    uint32_t *pAdcResult = (uint32_t *)&((ADC_TypeDef*) 0x40000000UL)->RESULT0;
...
void ADC_GetSqr0Result(uint16_t* pAdcResult)
{
    ...
    *pAdcResult = (uint16_t)(((ADC_TypeDef*) 0x40000000UL)->RESULT0);
}
...
void ADC_GetSqr1Result(uint16_t* pAdcResult)
{
    ...
    *pAdcResult = (uint16_t)(((ADC_TypeDef*) 0x40000000UL)->RESULT1);
}
...
void ADC_GetSqr2Result(uint16_t* pAdcResult)
{
    ...
    *pAdcResult = (uint16_t)(((ADC_TypeDef*) 0x40000000UL)->RESULT2);
}
...
void ADC_GetSqr3Result(uint16_t* pAdcResult)
{
    ...
    *pAdcResult = (uint16_t)(((ADC_TypeDef*) 0x40000000UL)->RESULT3);
}
...
void ADC_GetSqr4Result(uint16_t* pAdcResult)
{
    ...
    *pAdcResult = (uint16_t)(((ADC_TypeDef*) 0x40000000UL)->RESULT4);
}
...
void ADC_GetSqr5Result(uint16_t* pAdcResult)
{
    ...
    *pAdcResult = (uint16_t)(((ADC_TypeDef*) 0x40000000UL)->RESULT5);
}
...
void ADC_GetSqr6Result(uint16_t* pAdcResult)
{
    ...
    *pAdcResult = (uint16_t)(((ADC_TypeDef*) 0x40000000UL)->RESULT6);
}
...
void ADC_GetSqr7Result(uint16_t* pAdcResult)
{
    ...
    *pAdcResult = (uint16_t)(((ADC_TypeDef*) 0x40000000UL)->RESULT7);
}
...
void ADC_SetTs(uint32_t enTs)
{
    (((((enTs) == 0u) || ((enTs) == (((uint32_t)1u) << 2)))) ? (void)0U : assert_failed((uint8_t *)"..\\..\\..\\..\\Libraries\\src\\cw32l010_adc.c", 475));
    ( (((ADC_TypeDef*) 0x40000000UL)->CR) = ((((ADC_TypeDef*) 0x40000000UL)->CR) & (~(uint32_t)((0x4UL)))) | (enTs) );
...
float ADC_GetTs(float RefVoltage, uint32_t AdcValue)
{
    return (*((uint8_t *)((0x001007CD))) >> 1) +               (0.095765f)*  (RefVoltage *AdcValue - *(uint16_t *)((0x001007CE))*4.095);
