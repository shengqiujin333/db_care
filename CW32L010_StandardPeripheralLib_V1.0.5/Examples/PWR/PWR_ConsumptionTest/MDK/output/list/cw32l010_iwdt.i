#line 1 "..\\..\\..\\..\\Libraries\\src\\cw32l010_iwdt.c"
...
#line 13 "..\\..\\..\\..\\Libraries\\src\\cw32l010_iwdt.c"
...
#line 14 "..\\..\\..\\..\\Libraries\\src\\cw32l010_iwdt.c"
...
void IWDT_DeInit(void)
{
    ((SYSCTRL_TypeDef*) 0x40004000UL)->APBRST2_f.IWDT = 0;
    ((SYSCTRL_TypeDef*) 0x40004000UL)->APBRST2_f.IWDT = 1;
}
...
int IWDT_Init(IWDT_InitTypeDef *IWDT_InitStruct)
{
    ...
    (((((IWDT_InitStruct->IWDT_Prescaler) == ((uint32_t)0x00000000)) || ((IWDT_InitStruct->IWDT_Prescaler) == ((uint32_t)0x00000001)) || ((IWDT_InitStruct->IWDT_Prescaler) == ((uint32_t)0x00000002)) || ((IWDT_InitStruct->IWDT_Prescaler) == ((uint32_t)0x00000003)) || ((IWDT_InitStruct->IWDT_Prescaler) == ((uint32_t)0x00000004)) || ((IWDT_InitStruct->IWDT_Prescaler) == ((uint32_t)0x00000005)) || ((IWDT_InitStruct->IWDT_Prescaler) == ((uint32_t)0x00000007)))) ? (void)0U : assert_failed((uint8_t *)"..\\..\\..\\..\\Libraries\\src\\cw32l010_iwdt.c", 44));
    ((((IWDT_InitStruct->IWDT_OverFlowAction) == 0 || (IWDT_InitStruct->IWDT_OverFlowAction) == (0x8UL))) ? (void)0U : assert_failed((uint8_t *)"..\\..\\..\\..\\Libraries\\src\\cw32l010_iwdt.c", 45));
    ((((IWDT_InitStruct->IWDT_Pause) == (0x20UL) || (IWDT_InitStruct->IWDT_Pause) == 0)) ? (void)0U : assert_failed((uint8_t *)"..\\..\\..\\..\\Libraries\\src\\cw32l010_iwdt.c", 46));
    ((((IWDT_InitStruct->IWDT_WindowValue) <= 0xFFF)) ? (void)0U : assert_failed((uint8_t *)"..\\..\\..\\..\\Libraries\\src\\cw32l010_iwdt.c", 47));
    ((((IWDT_InitStruct->IWDT_ReloadValue) <= 0xFFF)) ? (void)0U : assert_failed((uint8_t *)"..\\..\\..\\..\\Libraries\\src\\cw32l010_iwdt.c", 48));
    
    ( (((SYSCTRL_TypeDef*) 0x40004000UL)->APBEN2) |= (((0x5A5A0000U) | (((uint32_t)1u) << 4))) );
    (((IWDT_TypeDef*) 0x40005000UL)->KR = 0xCCCC);                
    (((IWDT_TypeDef*) 0x40005000UL)->KR = 0x5555);             
    if (IWDT_InitStruct->IWDT_ITState == ENABLE)
    {
        ((IWDT_TypeDef*) 0x40005000UL)->CR = IWDT_InitStruct->IWDT_Prescaler |                       IWDT_InitStruct->IWDT_OverFlowAction |                       (0x10UL) | IWDT_InitStruct->IWDT_Pause;


    }
    else
    {
        ((IWDT_TypeDef*) 0x40005000UL)->CR = (IWDT_InitStruct->IWDT_Prescaler |                        IWDT_InitStruct->IWDT_OverFlowAction |                        IWDT_InitStruct->IWDT_Pause);


    }

    ((IWDT_TypeDef*) 0x40005000UL)->ARR = IWDT_InitStruct->IWDT_ReloadValue;
    ((IWDT_TypeDef*) 0x40005000UL)->WINR = IWDT_InitStruct->IWDT_WindowValue;

    while ((((IWDT_TypeDef*) 0x40005000UL)->SR & ((0x1UL) | (0x2UL) | (0x4UL))) && timeout--);
    if (timeout == 0) return 1;

    (((IWDT_TypeDef*) 0x40005000UL)->KR = 0x6666);
    return 0;
}
...
{
    (((IWDT_TypeDef*) 0x40005000UL)->KR = 0xAAAA);
}
...
{
    do{ ((IWDT_TypeDef*) 0x40005000UL)->KR = 0x5A5A; ((IWDT_TypeDef*) 0x40005000UL)->KR = 0xA5A5; } while(0);
}
...
{
    uint16_t timeout = 0xffff;
    (((((IWDT_Prescaler) == ((uint32_t)0x00000000)) || ((IWDT_Prescaler) == ((uint32_t)0x00000001)) || ((IWDT_Prescaler) == ((uint32_t)0x00000002)) || ((IWDT_Prescaler) == ((uint32_t)0x00000003)) || ((IWDT_Prescaler) == ((uint32_t)0x00000004)) || ((IWDT_Prescaler) == ((uint32_t)0x00000005)) || ((IWDT_Prescaler) == ((uint32_t)0x00000007)))) ? (void)0U : assert_failed((uint8_t *)"..\\..\\..\\..\\Libraries\\src\\cw32l010_iwdt.c", 123));

    (((IWDT_TypeDef*) 0x40005000UL)->KR = 0x5555);
    while ((((IWDT_TypeDef*) 0x40005000UL)->SR & (0x1UL)) && timeout--);
    if (timeout == 0) return 1;
    ((IWDT_TypeDef*) 0x40005000UL)->CR_f.PRS = IWDT_Prescaler;
    (((IWDT_TypeDef*) 0x40005000UL)->KR = 0x6666);
    return 0;
}
...
{
    uint16_t timeout = 0xffff;
    ((((WindowValue) <= 0xFFF)) ? (void)0U : assert_failed((uint8_t *)"..\\..\\..\\..\\Libraries\\src\\cw32l010_iwdt.c", 140));

    (((IWDT_TypeDef*) 0x40005000UL)->KR = 0x5555);
    while ((((IWDT_TypeDef*) 0x40005000UL)->SR & (0x4UL)) && timeout--);
    if (timeout == 0) return 1;
    ((IWDT_TypeDef*) 0x40005000UL)->WINR = WindowValue;
    (((IWDT_TypeDef*) 0x40005000UL)->KR = 0x6666);
    return 0;
}
...
{
    uint16_t timeout = 0xffff;
    ((((ReloadValue) <= 0xFFF)) ? (void)0U : assert_failed((uint8_t *)"..\\..\\..\\..\\Libraries\\src\\cw32l010_iwdt.c", 157));

    (((IWDT_TypeDef*) 0x40005000UL)->KR = 0x5555);
    while ((((IWDT_TypeDef*) 0x40005000UL)->SR & (0x2UL)) && timeout--);
    if (timeout == 0) return 1;
    ((IWDT_TypeDef*) 0x40005000UL)->ARR = ReloadValue;
    (((IWDT_TypeDef*) 0x40005000UL)->KR = 0x6666);
    return 0;
}
...
{
    uint16_t timeout = 0xffff;
    (((((NewState) == DISABLE) || ((NewState) == ENABLE))) ? (void)0U : assert_failed((uint8_t *)"..\\..\\..\\..\\Libraries\\src\\cw32l010_iwdt.c", 174));

    (((IWDT_TypeDef*) 0x40005000UL)->KR = 0x5555);
    while ((((IWDT_TypeDef*) 0x40005000UL)->SR & (0x1UL)) && timeout--);
    if (timeout == 0) return 1;
    NewState ? (((IWDT_TypeDef*) 0x40005000UL)->CR_f.IE = ENABLE) : (((IWDT_TypeDef*) 0x40005000UL)->CR_f.IE = DISABLE);
    (((IWDT_TypeDef*) 0x40005000UL)->KR = 0x6666);
    return 0;
}
...
FlagStatus IWDT_GetFlagStatus(uint32_t StatusBit)
{
    return (FlagStatus)(((IWDT_TypeDef*) 0x40005000UL)->SR & StatusBit);
}
...
{
    ((IWDT_TypeDef*) 0x40005000UL)->SR_f.OV = 0;
}
...
uint32_t IWDT_GetCounterValue(void)
{
    ...
    do
    {
        tmp1 = ((IWDT_TypeDef*) 0x40005000UL)->CNT;
        tmp2 = ((IWDT_TypeDef*) 0x40005000UL)->CNT;
    }
    while(tmp1 != tmp2);
...
void IWDT_SetPeriod(uint32_t period)
{
    ...
    ((((period) == 127 || (period) == 63 || (period) == 31 || (period) == 15)) ? (void)0U : assert_failed((uint8_t *)"..\\..\\..\\..\\Libraries\\src\\cw32l010_iwdt.c", 240));
    
    IWDT_InitStruct.IWDT_ITState = ENABLE;
    IWDT_InitStruct.IWDT_OverFlowAction = 0;
    IWDT_InitStruct.IWDT_Pause = (0x20UL) ;
    IWDT_InitStruct.IWDT_Prescaler = ((uint32_t)0x00000007);     
    IWDT_InitStruct.IWDT_WindowValue = 0xFFF;          
    IWDT_InitStruct.IWDT_ReloadValue = period;
    
    
    if (((SYSCTRL_TypeDef*) 0x40004000UL)->CR1_f.LSIEN == 0)
    {
        SYSCTRL_LSI_Enable();
    }
