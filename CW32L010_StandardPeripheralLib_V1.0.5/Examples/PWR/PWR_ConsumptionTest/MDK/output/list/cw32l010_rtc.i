#line 1 "..\\..\\..\\..\\Libraries\\src\\cw32l010_rtc.c"
...
#line 29 "..\\..\\..\\..\\Libraries\\src\\cw32l010_rtc.c"
...
#line 30 "..\\..\\..\\..\\Libraries\\src\\cw32l010_rtc.c"
...
void RTC_DeInit(void)
{
    ...
    ((RTC_TypeDef*) 0x40004400UL)->KEY_f.KEY = ((uint8_t)0xCA);
    ((RTC_TypeDef*) 0x40004400UL)->KEY_f.KEY = ((uint8_t)0x53);

     
    ((RTC_TypeDef*) 0x40004400UL)->DATE = ((uint32_t) 0x00000000);
    ((RTC_TypeDef*) 0x40004400UL)->TIME = ((uint32_t) 0x12000000);
    ((RTC_TypeDef*) 0x40004400UL)->ALARMA = ((uint32_t) 0x12000000);
    ((RTC_TypeDef*) 0x40004400UL)->ALARMB = ((uint32_t) 0x12000000);
    ((RTC_TypeDef*) 0x40004400UL)->AWTARR = ((uint32_t) 0x0000FFFF);
    ((RTC_TypeDef*) 0x40004400UL)->IER = ((uint32_t) 0x00000000);
    ((RTC_TypeDef*) 0x40004400UL)->ICR = 0UL;    

     
    ((RTC_TypeDef*) 0x40004400UL)->KEY_f.KEY = ((uint8_t)0xCA);
    ((RTC_TypeDef*) 0x40004400UL)->KEY_f.KEY = ((uint8_t)0x55);

     
    ((SYSCTRL_TypeDef*) 0x40004000UL)->APBRST2_f.RTC = 0;

     
    ((SYSCTRL_TypeDef*) 0x40004000UL)->APBEN2_f.RTC = 0;
}
...
ErrorStatus RTC_Init(RTC_InitTypeDef* RTC_InitStruct)
{
    (((((RTC_InitStruct->RTC_ClockSource) == (0UL)) || ((RTC_InitStruct->RTC_ClockSource) == (1UL << 8)) || ((RTC_InitStruct->RTC_ClockSource) == (2UL << 8)) || ((RTC_InitStruct->RTC_ClockSource) == (3UL << 8)))) ? (void)0U : assert_failed((uint8_t *)"..\\..\\..\\..\\Libraries\\src\\cw32l010_rtc.c", 82));
    ( (((SYSCTRL_TypeDef*) 0x40004000UL)->APBEN2) |= (((0x5A5A0000U) | (((uint32_t)1u) << 1))) );           
    if ((SYSCTRL_GetAllRstFlag() & (((uint32_t)1u) << 0)) != (((uint32_t)1u) << 0))  
    {    
        SYSCTRL_ClearRstFlag(((((uint32_t)1u) << 9)|(((uint32_t)1u) << 8)|(((uint32_t)1u) << 6)|(((uint32_t)1u) << 5)|(((uint32_t)1u) << 4)|(((uint32_t)1u) << 3)|(((uint32_t)1u) << 0)));        
        return SUCCESS;    
    }
    ...
    RTC_SetClockSource(RTC_InitStruct->RTC_ClockSource);        
...
void RTC_Cmd(FunctionalState NewState)
{
    (((((NewState) == DISABLE) || ((NewState) == ENABLE))) ? (void)0U : assert_failed((uint8_t *)"..\\..\\..\\..\\Libraries\\src\\cw32l010_rtc.c", 106));

    do{ ((RTC_TypeDef*) 0x40004400UL)->KEY_f . KEY = ((uint8_t)0xCA); ((RTC_TypeDef*) 0x40004400UL)->KEY_f . KEY = ((uint8_t)0x53); }while (0);

    ((RTC_TypeDef*) 0x40004400UL)->CR0_f.START = NewState;

    do{ ((RTC_TypeDef*) 0x40004400UL)->KEY_f . KEY = ((uint8_t)0xCA); ((RTC_TypeDef*) 0x40004400UL)->KEY_f . KEY = ((uint8_t)0x55);}while (0);
}
...
{
    uint32_t RegTmp;
    (((((RTC_ITState) == (1UL << 6)) || ((RTC_ITState) == (1UL << 4)) || ((RTC_ITState) == (1UL << 3)) || ((RTC_ITState) == (1UL << 2)) || ((RTC_ITState) == (1UL << 1)) || ((RTC_ITState) == (1UL)) || ((RTC_ITState) == ((1UL)|(1UL << 1)|(1UL << 2)|(1UL << 3)|(1UL << 4)|(1UL << 6)) ))) ? (void)0U : assert_failed((uint8_t *)"..\\..\\..\\..\\Libraries\\src\\cw32l010_rtc.c", 125));
    do
    {
        RegTmp = ((RTC_TypeDef*) 0x40004400UL)->ISR;
    }
    while (RegTmp != ((RTC_TypeDef*) 0x40004400UL)->ISR);
...
void RTC_ITConfig(uint32_t RTC_IT, FunctionalState NewState)
{
    ((((((uint8_t)(RTC_IT) & 0x20) == 0) && ((uint8_t)(RTC_IT) < 0x40))) ? (void)0U : assert_failed((uint8_t *)"..\\..\\..\\..\\Libraries\\src\\cw32l010_rtc.c", 143));
    (((((NewState) == DISABLE) || ((NewState) == ENABLE))) ? (void)0U : assert_failed((uint8_t *)"..\\..\\..\\..\\Libraries\\src\\cw32l010_rtc.c", 144));

    do{ ((RTC_TypeDef*) 0x40004400UL)->KEY_f . KEY = ((uint8_t)0xCA); ((RTC_TypeDef*) 0x40004400UL)->KEY_f . KEY = ((uint8_t)0x53); }while (0);

    ((RTC_TypeDef*) 0x40004400UL)->CR1_f.ACCESS = 1;
    while (!((RTC_TypeDef*) 0x40004400UL)->CR1_f.WINDOW);

    if (!NewState)
    {
        ((RTC_TypeDef*) 0x40004400UL)->IER &= ~RTC_IT;
    }
    else
    {
        ((RTC_TypeDef*) 0x40004400UL)->IER |= RTC_IT;
    ...
    ((RTC_TypeDef*) 0x40004400UL)->CR1_f.ACCESS = 0;
    do{ ((RTC_TypeDef*) 0x40004400UL)->KEY_f . KEY = ((uint8_t)0xCA); ((RTC_TypeDef*) 0x40004400UL)->KEY_f . KEY = ((uint8_t)0x55);}while (0);
}
...
void RTC_ClearITPendingBit(uint32_t RTC_IT)
{
    ((((((uint8_t)(RTC_IT) & 0x20) == 0) && ((uint8_t)(RTC_IT) < 0x40))) ? (void)0U : assert_failed((uint8_t *)"..\\..\\..\\..\\Libraries\\src\\cw32l010_rtc.c", 171));
    ...
    ((RTC_TypeDef*) 0x40004400UL)->ICR = ~RTC_IT;
...
void RTC_SetTime(RTC_TimeTypeDef* RTC_TimeStruct)
{
    ((((RTC_BCDToBin(RTC_TimeStruct->Second)) <= 59)) ? (void)0U : assert_failed((uint8_t *)"..\\..\\..\\..\\Libraries\\src\\cw32l010_rtc.c", 191));
    ((((RTC_BCDToBin(RTC_TimeStruct->Minute)) <= 59)) ? (void)0U : assert_failed((uint8_t *)"..\\..\\..\\..\\Libraries\\src\\cw32l010_rtc.c", 192));
    if (RTC_TimeStruct->H24 == (0UL))
        (((((RTC_BCDToBin(RTC_TimeStruct->Hour)) >= 1) && ((RTC_BCDToBin(RTC_TimeStruct->Hour)) <= 12))) ? (void)0U : assert_failed((uint8_t *)"..\\..\\..\\..\\Libraries\\src\\cw32l010_rtc.c", 194));
    else
        ((((RTC_BCDToBin(RTC_TimeStruct->Hour)) <= 23)) ? (void)0U : assert_failed((uint8_t *)"..\\..\\..\\..\\Libraries\\src\\cw32l010_rtc.c", 196));

    do{ ((RTC_TypeDef*) 0x40004400UL)->KEY_f . KEY = ((uint8_t)0xCA); ((RTC_TypeDef*) 0x40004400UL)->KEY_f . KEY = ((uint8_t)0x53); }while (0);

    ((RTC_TypeDef*) 0x40004400UL)->CR0_f.H24 = RTC_TimeStruct->H24;
    if (RTC_TimeStruct->H24 == (0UL))
    {
        ((RTC_TypeDef*) 0x40004400UL)->TIME = ((uint32_t)(RTC_TimeStruct->AMPM) << 21) |
    ...
    {
        ((RTC_TypeDef*) 0x40004400UL)->TIME = ((uint32_t)(RTC_TimeStruct->Hour) << 16) |
                       ((uint32_t)(RTC_TimeStruct->Minute) << 8) |
                       ((uint32_t)(RTC_TimeStruct->Second));
    }
...
{
    ((((RTC_BCDToBin(RTC_DateStruct->Year)) <= 99)) ? (void)0U : assert_failed((uint8_t *)"..\\..\\..\\..\\Libraries\\src\\cw32l010_rtc.c", 226));
    (((((RTC_BCDToBin(RTC_DateStruct->Month)) >= 1) && ((RTC_BCDToBin(RTC_DateStruct->Month)) <= 12))) ? (void)0U : assert_failed((uint8_t *)"..\\..\\..\\..\\Libraries\\src\\cw32l010_rtc.c", 227));
    (((((RTC_BCDToBin(RTC_DateStruct->Day)) >= 1) && ((RTC_BCDToBin(RTC_DateStruct->Day)) <= 31))) ? (void)0U : assert_failed((uint8_t *)"..\\..\\..\\..\\Libraries\\src\\cw32l010_rtc.c", 228));
    (((RTC_DateStruct->Week < 7)) ? (void)0U : assert_failed((uint8_t *)"..\\..\\..\\..\\Libraries\\src\\cw32l010_rtc.c", 229));

    do{ ((RTC_TypeDef*) 0x40004400UL)->KEY_f . KEY = ((uint8_t)0xCA); ((RTC_TypeDef*) 0x40004400UL)->KEY_f . KEY = ((uint8_t)0x53); }while (0);

    ((RTC_TypeDef*) 0x40004400UL)->DATE = ((uint32_t)(RTC_DateStruct->Week) << 24) |
...
void RTC_GetTime(RTC_TimeTypeDef* RTC_TimeStruct)
{
    ...
    RTC_TimeStruct->H24 = ((RTC_TypeDef*) 0x40004400UL)->CR0_f.H24;  

    RegTmp = ((RTC_TypeDef*) 0x40004400UL)->TIME;
    while (RegTmp != ((RTC_TypeDef*) 0x40004400UL)->TIME)
    {
        RegTmp = ((RTC_TypeDef*) 0x40004400UL)->TIME;    
    }

    RTC_TimeStruct->Hour = (uint8_t)((RegTmp & (0x3f0000UL)) >> 16);
    RTC_TimeStruct->Minute = (uint8_t)((RegTmp & (0x7f00UL)) >> 8);
    RTC_TimeStruct->Second = (uint8_t)(RegTmp & (0x7fUL));
    if (RTC_TimeStruct->H24 == (0UL))
    {
...
void RTC_GetDate(RTC_DateTypeDef* RTC_Date)
{
    ...
    RegTmp = ((RTC_TypeDef*) 0x40004400UL)->DATE;
    while (RegTmp != ((RTC_TypeDef*) 0x40004400UL)->DATE)
    {
        RegTmp = ((RTC_TypeDef*) 0x40004400UL)->DATE;    
    }

    RTC_Date->Day = (uint8_t)(RegTmp & (0xffUL));
    RTC_Date->Month = (uint8_t)((RegTmp & (0xff00UL)) >> 8);
    RTC_Date->Year = (uint8_t)((RegTmp & (0xff0000UL)) >> 16);
    RTC_Date->Week = (uint8_t)((RegTmp & (0x7000000UL)) >> 24);
}
...
void RTC_SetAlarm(uint32_t RTC_Alarm, RTC_AlarmTypeDef* RTC_AlarmStruct)
{
    ...
    (((((RTC_Alarm) == ((uint32_t)0x00000200)) || ((RTC_Alarm) == ((uint32_t)0x00000400)))) ? (void)0U : assert_failed((uint8_t *)"..\\..\\..\\..\\Libraries\\src\\cw32l010_rtc.c", 302));
    (((((RTC_AlarmStruct->RTC_AlarmMask) & 0x807F7F7F) == (uint32_t)RESET)) ? (void)0U : assert_failed((uint8_t *)"..\\..\\..\\..\\Libraries\\src\\cw32l010_rtc.c", 303));
    ((((RTC_BCDToBin(RTC_AlarmStruct->RTC_AlarmTime . Second)) <= 59)) ? (void)0U : assert_failed((uint8_t *)"..\\..\\..\\..\\Libraries\\src\\cw32l010_rtc.c", 304));
    ((((RTC_BCDToBin(RTC_AlarmStruct->RTC_AlarmTime . Minute)) <= 59)) ? (void)0U : assert_failed((uint8_t *)"..\\..\\..\\..\\Libraries\\src\\cw32l010_rtc.c", 305));
    if (RTC_AlarmStruct->RTC_AlarmTime.H24 == (0UL))
        (((((RTC_BCDToBin(RTC_AlarmStruct->RTC_AlarmTime . Hour)) >= 1) && ((RTC_BCDToBin(RTC_AlarmStruct->RTC_AlarmTime . Hour)) <= 12))) ? (void)0U : assert_failed((uint8_t *)"..\\..\\..\\..\\Libraries\\src\\cw32l010_rtc.c", 307));
    else
        ((((RTC_BCDToBin(RTC_AlarmStruct->RTC_AlarmTime . Hour)) <= 23)) ? (void)0U : assert_failed((uint8_t *)"..\\..\\..\\..\\Libraries\\src\\cw32l010_rtc.c", 309));
    ...
    if (RTC_Alarm == ((uint32_t)0x00000200))
    {
        ((RTC_TypeDef*) 0x40004400UL)->ALARMA = RegTmp;
    }
    else
    {
        ((RTC_TypeDef*) 0x40004400UL)->ALARMB = RegTmp;
    }
...
void RTC_GetAlarm(uint32_t RTC_Alarm, RTC_AlarmTypeDef* RTC_AlarmStruct)
{
    ...
    (((((RTC_Alarm) == ((uint32_t)0x00000200)) || ((RTC_Alarm) == ((uint32_t)0x00000400)))) ? (void)0U : assert_failed((uint8_t *)"..\\..\\..\\..\\Libraries\\src\\cw32l010_rtc.c", 343));

    if (RTC_Alarm == ((uint32_t)0x00000200))
    {
        RegTmp = ((RTC_TypeDef*) 0x40004400UL)->ALARMA;
        while (RegTmp != ((RTC_TypeDef*) 0x40004400UL)->ALARMA)
        {
            RegTmp = ((RTC_TypeDef*) 0x40004400UL)->ALARMA;
        }
    }
    ...
    {
        RegTmp = ((RTC_TypeDef*) 0x40004400UL)->ALARMB;
        while (RegTmp != ((RTC_TypeDef*) 0x40004400UL)->ALARMB)
        {
            RegTmp = ((RTC_TypeDef*) 0x40004400UL)->ALARMB;
        }
    }

    RTC_AlarmStruct->RTC_AlarmMask = RegTmp & ((uint32_t)0x7F808080);

    RTC_AlarmStruct->RTC_AlarmTime.H24 = ((RTC_TypeDef*) 0x40004400UL)->CR0_f.H24;     

    RTC_AlarmStruct->RTC_AlarmTime.Hour = (uint8_t)((RegTmp & (0x3f0000UL)) >> 16);
    RTC_AlarmStruct->RTC_AlarmTime.Minute = (uint8_t)((RegTmp & (0x7f00UL)) >> 8);
    RTC_AlarmStruct->RTC_AlarmTime.Second = (uint8_t)(RegTmp & (0x7fUL));
    if (RTC_AlarmStruct->RTC_AlarmTime.H24 == (0UL))
    {
...
void RTC_AlarmCmd(uint32_t RTC_Alarm, FunctionalState NewState)
{
    (((((RTC_Alarm) & (((uint32_t)0x00000200) | ((uint32_t)0x00000400))) != (uint32_t)RESET)) ? (void)0U : assert_failed((uint8_t *)"..\\..\\..\\..\\Libraries\\src\\cw32l010_rtc.c", 378));
    (((((NewState) == DISABLE) || ((NewState) == ENABLE))) ? (void)0U : assert_failed((uint8_t *)"..\\..\\..\\..\\Libraries\\src\\cw32l010_rtc.c", 379));

    do{ ((RTC_TypeDef*) 0x40004400UL)->KEY_f . KEY = ((uint8_t)0xCA); ((RTC_TypeDef*) 0x40004400UL)->KEY_f . KEY = ((uint8_t)0x53); }while (0);

    if ((((RTC_TypeDef*) 0x40004400UL)->CR0 & (((uint32_t)1u) << 7)))         
    {
        ((RTC_TypeDef*) 0x40004400UL)->CR1_f.ACCESS = 1;
        while (!((RTC_TypeDef*) 0x40004400UL)->CR1_f.WINDOW);
    }
    ...
    if (RTC_Alarm == ((uint32_t)0x00000200))
    {
        ((RTC_TypeDef*) 0x40004400UL)->CR2_f.ALARMAEN = NewState;
    }
    else
    {
        ((RTC_TypeDef*) 0x40004400UL)->CR2_f.ALARMBEN = NewState;
    }
...
void RTC_TamperTriggerConfig(uint32_t RTC_TamperTrigger)
{
    (((((RTC_TamperTrigger) == (0UL)) || ((RTC_TamperTrigger) == (1UL)))) ? (void)0U : assert_failed((uint8_t *)"..\\..\\..\\..\\Libraries\\src\\cw32l010_rtc.c", 404));
    ...
    ((RTC_TypeDef*) 0x40004400UL)->CR2_f.TAMPEDGE = RTC_TamperTrigger;
...
void RTC_TamperCmd(FunctionalState NewState)
{
    (((((NewState) == DISABLE) || ((NewState) == ENABLE))) ? (void)0U : assert_failed((uint8_t *)"..\\..\\..\\..\\Libraries\\src\\cw32l010_rtc.c", 422));
    ...
    ((RTC_TypeDef*) 0x40004400UL)->CR2_f.TAMPEN = NewState;
...
void RTC_GetTamperDate(RTC_DateTypeDef* RTC_Date)
{
    ...
    do
    {
        RegTmp = ((RTC_TypeDef*) 0x40004400UL)->TAMPDATE;
    }
    while (RegTmp != ((RTC_TypeDef*) 0x40004400UL)->TAMPDATE);

    RTC_Date->Week = (uint8_t)((RegTmp & (0xe000UL)) >> 13);
    RTC_Date->Month = (uint8_t)((RegTmp & (0x1f00UL)) >> 8);
    RTC_Date->Day = (uint8_t)(RegTmp & (0x3fUL));
}
...
void RTC_GetTamperTime(RTC_TimeTypeDef* RTC_TimeStruct)
{
    ...
    do
    {
        RegTmp = ((RTC_TypeDef*) 0x40004400UL)->TAMPTIME;
    }
    while (RegTmp != ((RTC_TypeDef*) 0x40004400UL)->TAMPTIME);     

    RTC_TimeStruct->Second = (uint8_t)((RegTmp & (0x7fUL)) >> 16);
    RTC_TimeStruct->Minute = (uint8_t)((RegTmp & (0x7f00UL)) >> 8);
    RTC_TimeStruct->Hour = (uint8_t)(RegTmp & (0x3f0000UL));
...
void RTC_OutputConfig(uint8_t RTC_Output)
{
    (((RTC_Output < 4)) ? (void)0U : assert_failed((uint8_t *)"..\\..\\..\\..\\Libraries\\src\\cw32l010_rtc.c", 484));
    ...
    ((RTC_TypeDef*) 0x40004400UL)->CR2_f.RTCOUT = RTC_Output;
...
void RTC_AWTConfig(RTC_AWTTypeDef* RCT_AWTStruct)
{
    (((RCT_AWTStruct->AWT_ClockSource < 8)) ? (void)0U : assert_failed((uint8_t *)"..\\..\\..\\..\\Libraries\\src\\cw32l010_rtc.c", 507));
    ...
    ((RTC_TypeDef*) 0x40004400UL)->CR2_f.AWTSRC = RCT_AWTStruct->AWT_ClockSource;
    ((RTC_TypeDef*) 0x40004400UL)->AWTARR = (uint32_t)RCT_AWTStruct->AWT_ARRValue;
...
void RTC_AWTCmd(FunctionalState NewState)
{
    (((((NewState) == DISABLE) || ((NewState) == ENABLE))) ? (void)0U : assert_failed((uint8_t *)"..\\..\\..\\..\\Libraries\\src\\cw32l010_rtc.c", 532));
    ...
    ((RTC_TypeDef*) 0x40004400UL)->CR2_f.AWTEN = NewState;
...
void RTC_SetInterval(uint8_t Period)
{
    (((Period < 7)) ? (void)0U : assert_failed((uint8_t *)"..\\..\\..\\..\\Libraries\\src\\cw32l010_rtc.c", 556));
    ...
    ((RTC_TypeDef*) 0x40004400UL)->CR0_f.INTERVAL = Period;
...
void RTC_SetClockSource(uint32_t RTC_ClockSource)
{
    (((((RTC_ClockSource) == (0UL)) || ((RTC_ClockSource) == (1UL << 8)) || ((RTC_ClockSource) == (2UL << 8)) || ((RTC_ClockSource) == (3UL << 8)))) ? (void)0U : assert_failed((uint8_t *)"..\\..\\..\\..\\Libraries\\src\\cw32l010_rtc.c", 581));

    do{ ((RTC_TypeDef*) 0x40004400UL)->KEY_f . KEY = ((uint8_t)0xCA); ((RTC_TypeDef*) 0x40004400UL)->KEY_f . KEY = ((uint8_t)0x53); }while (0);     


    ((RTC_TypeDef*) 0x40004400UL)->CR1 = RTC_ClockSource;    
...
void RTC_CalibrationConfig(RTC_CalibTypeDef* RTC_CalibStruct)
{
    (((RTC_CalibStruct->Freq < 9)) ? (void)0U : assert_failed((uint8_t *)"..\\..\\..\\..\\Libraries\\src\\cw32l010_rtc.c", 598));
    ((((RTC_CalibStruct->Step) < 3)) ? (void)0U : assert_failed((uint8_t *)"..\\..\\..\\..\\Libraries\\src\\cw32l010_rtc.c", 599));
    ((((RTC_CalibStruct->Sign) < 2)) ? (void)0U : assert_failed((uint8_t *)"..\\..\\..\\..\\Libraries\\src\\cw32l010_rtc.c", 600));
    (((((RTC_CalibStruct->CompensationValue) & 0xFFFFF000) == RESET)) ? (void)0U : assert_failed((uint8_t *)"..\\..\\..\\..\\Libraries\\src\\cw32l010_rtc.c", 601));
    ...
    ((RTC_TypeDef*) 0x40004400UL)->COMPCFR1 = (RTC_CalibStruct->Sign << 14) |
...
void RTC_CalibrationCmd(FunctionalState NewState)
{
    (((((NewState) == DISABLE) || ((NewState) == ENABLE))) ? (void)0U : assert_failed((uint8_t *)"..\\..\\..\\..\\Libraries\\src\\cw32l010_rtc.c", 622));
    ...
    ((RTC_TypeDef*) 0x40004400UL)->COMPCFR1_f.EN = NewState;
...
void RTC_AWT_PSC_set(uint8_t PSC1A,uint32_t PSC2A)
{
    ...
    ((RTC_TypeDef*) 0x40004400UL)->PSC_f.PSC1 = PSC1A;
    ((RTC_TypeDef*) 0x40004400UL)->PSC_f.PSC2 = PSC2A;
