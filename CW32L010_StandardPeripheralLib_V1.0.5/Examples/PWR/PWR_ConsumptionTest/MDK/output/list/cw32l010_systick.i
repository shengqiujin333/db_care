#line 1 "..\\..\\..\\..\\Libraries\\src\\cw32l010_systick.c"
...
#line 31 "..\\..\\..\\..\\Libraries\\src\\cw32l010_systick.c"
...
uint32_t uwTickPrio   = (1UL << 2);  
TickFreqTypeDef uwTickFreq = TICK_FREQ_DEFAULT;   
...
__attribute__((weak)) void InitTick(uint32_t HclkFreq)
{
    ...
    if (((uint32_t)0) < (1UL << 2))
    {
        __NVIC_SetPriority(SysTick_IRQn, ((uint32_t)0));
        uwTickPrio = ((uint32_t)0);
    }
    else
    {
        return ;
...

{
    ...
    ( (((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->CTRL) &= (~((uint32_t)((1UL << 1U)))) );
}
